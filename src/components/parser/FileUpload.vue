...
<template>
  <div
    ...
    :class="isDragging ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-blue-400 bg-white dark:bg-gray-800'"
  ...
  >
    ...
    <div class="flex flex-col items-center justify-center gap-2 text-gray-500 dark:text-gray-400">
      ...
      <p class="text-sm text-gray-500 dark:text-gray-500 mt-1">지원하는 문서 포멧: <span class="font-semibold text-indigo-600 dark:text-indigo-400">TXT, DOCX, PDF, HWP</span></p>
    </div>
  </div>
</template>
